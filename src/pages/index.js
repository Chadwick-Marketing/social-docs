        ...
        <div className="center homepage-content">
          ...
          >
            ...
            <button
              ...
              type="button"
              class="text-white bg-social-blue cursor-pointer flex items-center border-none hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none "
            >
              Get started
              <svg
                aria-hidden="true"
